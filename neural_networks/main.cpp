...
void ComputeGradientLayerZeroWeights(const NeuralNetworkParameters& nn,
...
void ComputeGradientLayerOneWeights(const NeuralNetworkParameters& nn,
                                    const Eigen::VectorXd& input) {
...
int main() {
  ...
  ComputeGradientLayerZeroWeights(nn, input);
  ComputeGradientLayerOneWeights(nn, input);
